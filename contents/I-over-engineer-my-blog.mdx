...
Welcome to my first posts in the my digital blogs. If you are reading this, I am really grateful that you are spending time on visiting my website. Now let the journey begins then.

---

# Trying [NextJS](https://nextjs.org/) for the first time

I heard from lots of people that I should give NextJS a try if I love ReactJS and to be 
...
# Trying [MDX](https://mdxjs.com/) for the first time
...
your friends, or someone who don't usually interact with MD, which version is more readable?
...
# Trying [ChakraUI](https://chakra-ui.com/) for the fisrt time

CSS Framework is quite similar to each other. I will **not recommend you to learn many CSS frameworks at the same time but try to focus on one and be 
good at it, so you can style the website quickly and more efficient** (except for your job).
ChakraUI is components css framework which basically means that
