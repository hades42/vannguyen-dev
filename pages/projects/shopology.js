...
const Project = () => {
  ...
  return (
    <>
      <PageSeo
        title={`${title} - Shopology`}
        description={`E-commerce platform built with MERN stack (MongoDB, ExpressJS, ReactJS, Nodejs)`}
      />
      <GeneralContainer>
          ...
          <Container my={8}>
            ...
            <List ml={4} my={4}>
              <ListItem>
                ...
                (The website could be taken a while to be loaded since the
                project is on a free Heroku machine)
              </ListItem>
              <ListItem>
                <Meta>Github</Meta>
